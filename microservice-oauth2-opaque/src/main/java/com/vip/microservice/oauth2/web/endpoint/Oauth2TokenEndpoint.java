package com.vip.microservice.oauth2.web.endpoint;

import com.vip.microservice.oauth2.service.Oauth2RegisteredClientService;
import com.vip.microservice.oauth2.support.security.core.exception.OAuth2ClientException;
...
public class Oauth2TokenEndpoint {
    ...
    public ModelAndView confirm(Principal principal, ModelAndView modelAndView,
        ...
        RegisteredClient registeredClient = registeredClientService.findByClientId(clientId)
                .orElseThrow(() -> new OAuth2ClientException("clientId 不合法"));
